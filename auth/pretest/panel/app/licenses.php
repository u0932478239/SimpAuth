                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <?php
                            ...
                            <form method="POST" action="">
                                ...
                                <h5>Prefix <small>(Optional for premium users)</small></h5>
                                <input type="text" id="text" class="form-control" name="prefix_licenses" placeholder="Option only for premiums" value="AkizaIO">
                                <br>
