...
<head>
    <title>Akiza | Account Settings</title>
    <meta charset="utf-8">
    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="../dashboard/prices.php" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
        ...
        else
        {
            ...
            if (password_verify($currentpass, $pass))
            {
                ...
                else
                {
                    ...
                    $from = "noreply@akiza.io";
                    $subject = 'AKIZA - Password Changed';

                    $content = "PASS CHANGED";
                    $htmlContent = ' 
                    <html> 
                    <head> 
                     <title>AKIZA - Password changed!</title> 
                    </head> 
                    <body> 
                        <h1>Your password has been changed!</h1> 
                       
                        <p style="margin-top: 20px;">Thanks,<br><b>AkizaIO Support.</b></p>
                    </body> 
                    </html>';
                                        ...
                                        if (mysqli_num_rows($result_api_key) > 0)
                                        {
                                            ...
                                            if ($update_api_key)
                                            {
                                                ...
                                                echo '
                                                    ...
                                                    notyf
                                                    .success({
                                                        message: \'Successfully generated a new api key!\',
                                                        duration: 3500,
                                                        dismissible: true
                                                    });                
                                                            ...
                                                            <div class="form">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control mb-4" value="<?php echo ($subscription == "1" ? $api_key : "You can't get the API key without a premium subscription!"); ?>" disabled>
                                                ...
                                                <div class="col-md-11 mx-auto">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            </div><h6 style="color: gray">(Please make sure it is well written, this will help the support)</h6>
                                                        </div>                                                     
                                                    </div>
                                                    <br>
