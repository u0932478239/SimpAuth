        ...
        if ($responseKeys["success"])
        {
            ...
            if (mysqli_num_rows($result) == 1)
            {
                ...
                $htmlContent = ' 
                    <html> 
                    <head> 
                        <title>SimpAuth - You Requested A Password Reset</title> 
                    </head> 
                    <body> 
                        ...
                        <p style="margin-top: 20px;">Thanks,<br><b> SimpAuth.</b></p>
                    </body> 
                    </html>'; 
                ...
                $subject = 'SimpAuth - Password Reset';

                $from = "noreply@simpauth.xyz";
